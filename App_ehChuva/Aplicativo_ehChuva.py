...
######## CRIAR A AREA CANVAS
        self.canvas = Canvas(master, width = 360, height = 640, highlightthickness=0)
        self.canvas.pack()
...
######## MENSAGENS DE AVISO:     CAMPO VAZIO E LOGIN INVALIDO
        mensagem = self.canvas.create_text(180, 600, text = '', font = ("Arial", "12"), fill = 'red', justify = 'center')
...
######## BOTAO CADASTRO
        self.cadastrar_text = self.canvas.create_text(180, 540, text = 'Não tem uma conta? Cadastre-se', font = ("Lemon Milk", "13", "bold"), justify = 'center', fill = 'blue')
